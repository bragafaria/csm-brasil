// src/app/dashboard/[siteId]/finances-planning/page.js
"use client";
...
import FinancialTemplate from "@/app/lib/couple/FinancialTemplate"; // Use alias, match export name
...
export default function FinancesPlanningPage() {
  ...
  useEffect(() => {
    async function fetchReportData() {
      ...
      try {
        ...
        console.log("FinancesPlanning session user ID:", session.user.id);
  ...
  const { description } = FinancialTemplate.generateText(partnerA, partnerB);
