  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 text-[var(--text-secondary)] leading-relaxed scroll mb-8">
      <div className="card-gradient p-6 rounded-lg shadow-custom">
        <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-8 mt-4">Important Context Before Reading</h3>

        <div className="space-y-6">
          <div>
            <p className="text-lg leading-relaxed">
              This section helps you see where your minds naturally differ, and how those differences shape your daily
              interactions. It gently highlights the moments where tension, miscommunication, or emotional friction
              might arise, not as warnings, but as{" "}
              <span className="font-medium">invitations to understand each other more deeply</span>.
            </p>
