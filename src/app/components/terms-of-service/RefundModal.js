        ...
        <div className="overflow-y-auto h-[calc(100%-80px)] px-6 py-6 text-[var(--text-secondary)] space-y-6 custom-scrollbar">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-3">
              2. {`Couple's Insights Report`} ($49 One-Time Payment)
            </h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-base">
                  ...
                  <li>
                    <strong>Access Removal:</strong> Upon refund approval, access to the {`Couple's Insights Report`}{" "}
                    will be revoked
                  </li>
                </ul>
              </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base leading-relaxed">
                  As an upsell from the {`Couple's Insights Report`}, you receive{" "}
