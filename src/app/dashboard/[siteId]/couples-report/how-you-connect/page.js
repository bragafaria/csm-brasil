...
export default function HowYouConnectPageRoute() {
  ...
  const pageTitle = `Como Vocês se Conectam`;
  const subHeading = `Explore a química natural e os padrões de conexão entre ${data.partnerA.name} e ${data.partnerB.name}.`;
