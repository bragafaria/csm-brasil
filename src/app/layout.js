...
export const metadata = {
  ...
  description:
    "Take a free 10-minute personality test to discover your unique CSM cognitive profile, understand thinking differences, and build deeper connection & intimacy fast.",
