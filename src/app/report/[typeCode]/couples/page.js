          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            {[
              ...
              },
              {
                ...
                desc: "Once your partner completes the assessment, your personalized Couple’s Insights Report is generated by our algorithm based on your individual results.",
                icon: Heart,
              },
            ].map((item, index) => (
